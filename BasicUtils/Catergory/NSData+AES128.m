...
static const char encodingTable[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/";
...
/*加密方法*/
+ (NSString *)AES128EncryptWithPlainText:(NSString *)plain password:(NSString *)password{
    ...
    if (cryptStatus == kCCSuccess) {
        ...
        return [encryptData base64Encoding1];
    }
...
/*解密方法*/
+ (NSString *)AES128DecryptWithCiphertext:(NSString *)ciphertexts password:(NSString *)password{
