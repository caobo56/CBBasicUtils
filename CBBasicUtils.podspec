...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/caobo56/CBBasicUtils.git", :tag => "1.0.18" }
  ...
  s.default_subspec = 'ArrBounds','Requset','MacroAndConstant','Util','BasicVC','BasicClass','Catergory','ShareView'
