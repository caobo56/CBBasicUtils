...
+ (NSString*)getChineseCalendarWithDate:(NSDate *)date{
    ...
    NSString *y_str = [LunarUtil yearGanzhiStringFromDate:date type:StateNongLi];
...
+(NSString *)zodiacStringFromDate:(NSDate *)inputDate type:(GanZhiState)type{
    ...
    NSString * year_ganzhi_str = [LunarUtil yearGanzhiStringFromDate:inputDate type:type];
    NSString * zodiac = @"";
...
+ (NSString *)yearGanzhiStringFromDate:(NSDate*)inputDate type:(GanZhiState)type{
    NSArray *chineseYears = [LunarUtil jiaziArr];
    NSCalendar *localeCalendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierChinese];
    unsigned unitFlags = NSCalendarUnitYear | NSCalendarUnitMonth |  NSCalendarUnitDay;
    ...
    if(type == StateGanZhiLi){
        NSComparisonResult result = [inputDate compare:[LunarUtil liChunDateFromDate:inputDate]];
...
+(NSString *)mouthGanzhiStringFromDate:(NSDate *)inputDate{
    ...
    NSString * year_ganzhi = [LunarUtil yearGanzhiStringFromDate:inputDate type:StateGanZhiLi];
    NSInteger mouth_zhi_index = [LunarUtil mouthZhiIndexFromDate:inputDate];
...
+ (NSString *)dayGanzhiStringFromDate:(NSDate*)inputDate{
    ...
    NSArray *ganzhi_Arr = [LunarUtil jiaziArr];
...
+(NSString *)jianxingStringFromDate:(NSDate*)inputDate{
    ...
    NSInteger mouth_zhi_index = [LunarUtil mouthZhiIndexFromDate:inputDate];
    NSString * day_ganzhi = [LunarUtil dayGanzhiStringFromDate:inputDate];
...
+(NSDictionary *)YiJi:(NSDate *)inputDate{
    ...
    NSString * jian = [LunarUtil jianxingStringFromDate:inputDate];
    NSDictionary * yiji = @{};
